...
export class CreateUserDto {
  ...
  @IsNotEmpty()
  @ApiProperty({ description: 'Roles del usuario.', example: ['f49e75f2-4359-4276-a148-3c10c5aae7fg', 'f49e75f2-4359-4276-a148-3c10c5aae7fw'] })
  roles: string[];

  @IsOptional()
  @ApiProperty({ description: 'Funciones del usuario.', example: ['f49e75f2-4359-4276-a148-3c10c5aae7fq', 'f49e75f2-4359-4276-a148-3c10c5aae7fd'] })
  functions?: string[];
