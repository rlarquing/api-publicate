...
export class UpdateMultipleFunctionDto {
  @IsNotEmpty()
  @ApiProperty({ description: 'id de la fimción', example: 'f49e75f2-4359-4276-a148-3c10c5aae7fd' })
  id: string;
  ...
  @ApiProperty({
    ...
    example: ['f49e75f2-4359-4276-a148-3c10c5aae7ff'],
  })
  endPoints: string[];
